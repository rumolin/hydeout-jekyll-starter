...
Leider hatte ich noch keine Gelegenheit, meine anderen offenen To Do's aus dem letzten Block abzuarbeiten:
  *	Auf der Hauptseite soll nicht mehr der ganze Blogartikel sichtbar sein, sondern nur noch eine Vorschau (inklusive Beitragsbild) (inzwischen erledigt)
  *	About, Thema 1, Thema 2 und Post Formats (Menüpunkte in der Sidebar) sollen im Laufe der Zeit zu Überthemen umbenannt werden, worüber passende Blogposts jeweils gefunden werden können. (inzwischen erledigt)
...
Und hier mein Beispiel für eine HTML-Website:
     ...
     <head profile="http://dublincore.org/documents/dcq-html/">
        <titel>BAIN Lerntagebuch</titel>
            <link rel="schema.DC" href="http://purl.org/dc/elements/1.1">
            <link rel="schema.DCTERMs" href="http://purl.org/dc/terms/">
            <meta name="DC.format" scheme="DCTERMS.IMT" content="text/html"/>
            <meta name="DC.title" content="Harper Lee"/>
        </head>
...
* DC weist eine Vielzahl von Tags auf, die ohne viel Hintergrundwissen zu verstehen sind
